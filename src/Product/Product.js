...
import img1 from '../images/cala-w6ftFbPCs9I-unsplash.jpg'
import img2 from '../images/joseph-gonzalez-fdlZBWIP0aM-unsplash.jpg'
import img3 from '../images/casey-lee-awj7sRviVXo-unsplash.jpg'
import img4 from '../images/chad-montano-eeqbbemH9-c-unsplash.jpg'
    ...
    <div>
        ...
        <div class="container px-5 py-24 mx-auto">
          ...
          <div class="flex flex-wrap -m-4">
            ...
            <div class="xl:w-1/4 md:w-1/2 p-4">
              <div class="bg-gray-100 p-6 rounded-lg">
                <img class="h-40 rounded w-full object-cover object-center mb-6" src={img4} alt="content" />
                <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font">SUBTITLE</h3>
